import { g as Vt, s as Bt, w as Nt } from "../core-7dHX86aP.js";
import { b as Qt, e as Yt, j as rn, j as en, p as tn, k as nn } from "../core-7dHX86aP.js";
var gr = (() => {
  ...
  return function(z = {}) {
    ...
    var mr = Object.assign({}, u), br = typeof window == "object", wr = typeof Bun < "u", Q = typeof importScripts == "function";
    typeof process == "object" && typeof process.versions == "object" && process.versions.node;
    var C = "";
    function Yr(r) {
      return u.locateFile ? u.locateFile(r, C) : C + r;
    }
    var or;
    (br || Q || wr) && (Q ? C = self.location.href : typeof document < "u" && document.currentScript && (C = document.currentScript.src), S && (C = S), C.indexOf("blob:") !== 0 ? C = C.substr(0, C.replace(/[?#].*/, "").lastIndexOf("/") + 1) : C = "", Q && (or = (r) => {
    ...
    var Y, Tr = !1, U, y, O, L, j, _, $r, Ar;
    function Er() {
      var r = Y.buffer;
      u.HEAP8 = U = new Int8Array(r), u.HEAP16 = O = new Int16Array(r), u.HEAPU8 = y = new Uint8Array(r), u.HEAPU16 = L = new Uint16Array(r), u.HEAP32 = j = new Int32Array(r), u.HEAPU32 = _ = new Uint32Array(r), u.HEAPF32 = $r = new Float32Array(r), u.HEAPF64 = Ar = new Float64Array(r);
    }
    var Rr = [], Cr = [], Fr = [];
    function re() {
      if (u.preRun)
    ...
    function oe(r) {
      var e;
      M++, (e = u.monitorRunDependencies) === null || e === void 0 || e.call(u, M);
    }
    function se(r) {
      var e;
      if (M--, (e = u.monitorRunDependencies) === null || e === void 0 || e.call(u, M), M == 0 && Z) {
        var t = Z;
        Z = null, t();
      }
    }
    function sr(r) {
      var e;
      (e = u.onAbort) === null || e === void 0 || e.call(u, r), r = "Aborted(" + r + ")", N(r), Tr = !0, r += ". Build with -sASSERTIONS for more info.";
      var t = new WebAssembly.RuntimeError(r);
      throw J(t), t;
    }
    var ue = "data:application/octet-stream;base64,", Pr = (r) => r.startsWith(ue), H;
    H = "zxing_writer.wasm", Pr(H) || (H = Yr(H));
    function Wr(r) {
      if (r == H && X)
    ...
    function fe(r) {
      return !X && (br || Q || wr) && typeof fetch == "function" ? fetch(r, {
        credentials: "same-origin"
      }).then((e) => {
        if (!e.ok)
          throw "failed to load wasm binary file at '" + r + "'";
        return e.arrayBuffer();
      }).catch(() => Wr(r)) : Promise.resolve().then(() => Wr(r));
    }
    function kr(r, e, t) {
      return fe(r).then((n) => WebAssembly.instantiate(n, e)).then((n) => n).then(t, (n) => {
        N(`failed to asynchronously prepare wasm: ${n}`), sr(n);
      });
    }
    function ce(r, e, t, n) {
      return !r && typeof WebAssembly.instantiateStreaming == "function" && !Pr(e) && typeof fetch == "function" ? fetch(e, {
        credentials: "same-origin"
      }).then((a) => {
        var i = WebAssembly.instantiateStreaming(a, t);
        return i.then(n, function(o) {
          return N(`wasm streaming compile failed: ${o}`), N("falling back to ArrayBuffer instantiation"), kr(e, t, n);
        });
      }) : kr(e, t, n);
    }
    function le() {
      ...
      function e(n, a) {
        return g = n.exports, Y = g.R, Er(), Br = g.V, ae(g.S), se(), g;
      }
      oe();
      function t(n) {
        e(n.instance);
    ...
    var Sr = [], ve = (r) => {
      var e = new fr(r);
      return e.get_caught() || e.set_caught(!0), e.set_rethrown(!1), Sr.push(e), Kr(e.excPtr), e.get_exception_ptr();
    }, x = 0, de = () => {
      T(0, 0);
      var r = Sr.pop();
      Gr(r.excPtr), x = 0;
    ...
    var _e = (r) => {
      ...
      return G(n), e;
    }, he = () => cr([]), pe = (r) => cr([r]), ge = (r, e) => cr([r, e]), ye = (r, e, t) => {
      var n = new fr(r);
    ...
    var V = {}, I = {}, er = {}, Ur, jr = (r) => {
      ...
      function n(s) {
        var f = t(s);
        f.length !== r.length && jr("Mismatched type converter count");
      ...
      Mr([r], i, (o) => {
        ...
        return a.forEach((f, c) => {
          var l = f.fieldName, v = o[c], h = f.getter, d = f.getterContext, k = o[c + a.length], R = f.setter, m = f.setterContext;
          s[l] = {
            read: (K) => v.fromWireType(h(d, K)),
            write: (K, pr) => {
              var ir = [];
              R(m, K, k.toWireType(ir, pr)), lr(ir);
            }
          };
        }), [{
          name: e.name,
    ...
    function Te(r, e) {
      ...
      var n = e.name;
      if (r || b(`type "${n}" must have a positive integer typeid pointer`), I.hasOwnProperty(r)) {
        if (t.ignoreDuplicateRegistrations)
          return;
        b(`Cannot register type '${n}' twice`);
      }
      if (I[r] = e, delete er[r], V.hasOwnProperty(r)) {
        var a = V[r];
    ...
    var $ = new Dr(), dr = (r) => {
      ...
      $.allocated.push({
        ...
        value: !1
      }), $.reserved = $.allocated.length, u.count_emval_handles = Ee;
    }, D = {
      ...
      u.hasOwnProperty(r) ? ((t === void 0 || u[r].overloadTable !== void 0 && u[r].overloadTable[t] !== void 0) && b(`Cannot register public name '${r}' twice`), Fe(u, r, r), u.hasOwnProperty(t) && b(`Cannot register multiple overloads of a function with the same number of arguments (${t})!`), u[r].overloadTable[t] = e) : (u[r] = e, t !== void 0 && (u[r].numArguments = t));
    }, Pe = (r, e, t) => {
      switch (e) {
        case 1:
          return t ? function(n) {
      ...
      var t = I[r];
      return t === void 0 && b(e + " has unknown type " + Hr(r)), t;
    }, ke = (r, e, t) => {
      var n = Vr(r, "enum");
      e = p(e);
    ...
    function Me(r, e, t, n, a, i) {
      ...
      var s = e[1] !== null && t !== null, f = je(e), c = e[0].name !== "void", l = o - 2, v = new Array(l), h = [], d = [], k = function() {
        arguments.length !== l && b(`function ${r} called with ${arguments.length} arguments, expected ${l}`), d.length = 0;
        var R;
        h.length = s ? 2 : 1, h[0] = a, s && (R = e[1].toWireType(d, this), h[1] = R);
        for (var m = 0; m < l; ++m)
        ...
        function pr(ir) {
          if (f)
            ...
            for (var B = s ? 1 : 2; B < e.length; B++) {
              var Ht = B === 1 ? R : v[B - 2];
              e[B].destructorFunction !== null && e[B].destructorFunction(Ht);
            }
          if (c)
    ...
    var xe = (r, e) => {
      ...
      u.hasOwnProperty(r) || jr("Replacing nonexistant public symbol"), u[r].overloadTable !== void 0 && t !== void 0 ? u[r].overloadTable[t] = e : (u[r] = e, u[r].argCount = t);
    }, De = (r, e, t) => {
      var n = u["dynCall_" + r];
      ...
      r = p(r);
      function t() {
        return r.includes("j") ? He(r, e) : w(e);
      }
      var n = t();
...
` + a.replace(/^Error(:[^\n]*)?\n/, ""));
      ...
      throw e.forEach(a), new Nr(`${r}: ` + t.map(Hr).join([", "]));
    }, Ne = (r) => {
      r = r.trim();
      const e = r.indexOf("(");
    ...
    var Ke = (r, e, t, n) => {
      ...
      F(r, {
        ...
        toWireType(n, a) {
          ...
          o || a instanceof Uint8Array || a instanceof Uint8ClampedArray || a instanceof Int8Array || b("Cannot pass non-string to std::string"), t && o ? i = Je(a) : i = a.length;
    ...
    }, Lr = typeof TextDecoder < "u" ? new TextDecoder("utf-16le") : void 0, et = (r, e) => {
      for (var t = r, n = t >> 1, a = n + e / 2; !(n >= a) && L[n]; )
        ++n;
      if (t = n << 1, t - r > 32 && Lr)
        return Lr.decode(y.subarray(r, t));
      ...
      t = p(t);
      var n, a, i, o, s;
      e === 2 ? (n = et, a = tt, o = nt, i = () => L, s = 1) : e === 4 && (n = at, a = it, o = ot, i = () => _, s = 2), F(r, {
        name: t,
        fromWireType: (f) => {
    ...
    }, _r = [], lt = (r, e, t, n) => (r = _r[r], e = D.toValue(e), r(null, e, t, n)), vt = {}, dt = (r) => {
      var e = vt[r];
    ...
    }, _t = (r) => r === 0 ? D.toHandle(Zr()) : (r = dt(r), D.toHandle(Zr()[r])), ht = (r) => {
      var e = _r.length;
      return _r.push(r), e;
    }, pt = (r, e) => {
      for (var t = new Array(r), n = 0; n < r; ++n)
        t[n] = Vr(_[e + n * 4 >> 2], "parameter " + n);
      return t;
    }, gt = Reflect.construct, yt = (r, e, t) => {
      var n = [], a = r.toWireType(n, t);
      return n.length && (_[e >> 2] = D.toHandle(n)), a;
    }, mt = (r, e, t) => {
      ...
      var i = new Array(r), o = (f, c, l, v) => {
        ...
        for (var k = t === 1 ? gt(c, i) : c.apply(f, i), d = 0; d < r; ++d) {
          var R, m;
          (R = (m = n[d]).deleteObject) === null || R === void 0 || R.call(m, i[d]);
        }
        return yt(a, l, k);
      ...
      sr("");
    }, $t = (r, e, t) => y.copyWithin(r, e, e + t), At = () => 2147483648, Et = (r) => {
      var e = Y.buffer, t = (r - e.byteLength + 65535) / 65536;
      try {
        return Y.grow(t), Er(), 1;
      } catch {
      }
    }, Rt = (r) => {
      var e = y.length;
      ...
      for (var n = (f, c) => f + (c - f % c) % c, a = 1; a <= 4; a *= 2) {
        ...
        var o = Math.min(t, n(Math.max(r, i), 65536)), s = Et(o);
        if (s)
          return !0;
      }
      return !1;
    }, Ct = (r) => r;
    Ur = u.InternalError = class extends Error {
      constructor(e) {
    ...
    }, Ae(), Re(), Nr = u.UnboundTypeError = Ve(Error, "UnboundTypeError");
    var Ft = {
      r: ve,
      q: de,
      g: he,
      ...
      j: It,
      O: Ct
    }, g = le(), hr = u._malloc = (r) => (hr = u._malloc = g.T)(r), W = u._free = (r) => (W = u._free = g.U)(r), qr = (r) => (qr = g.W)(r), T = (r, e) => (T = g.X)(r, e), G = (r) => (G = g.Y)(r), A = () => (A = g.Z)(), E = (r) => (E = g._)(r), Gr = (r) => (Gr = g.$)(r), Kr = (r) => (Kr = g.aa)(r), zr = (r, e, t) => (zr = g.ba)(r, e, t), Jr = (r) => (Jr = g.ca)(r);
    function Pt(r, e) {
      var t = A();
      try {
        return w(r)(e);
    ...
    function It(r, e, t, n, a, i, o, s, f, c, l) {
      var v = A();
      try {
    ...
    function Qr() {
      if (M > 0 || (re(), M > 0))
        return;
      function r() {
        ar || (ar = !0, u.calledRun = !0, !Tr && (ee(), yr(u), u.onRuntimeInitialized && u.onRuntimeInitialized(), te()));
      }
...
export {
  ...
  Yt as characterSets,
  rn as defaultEncodeHints,
  en as defaultWriterOptions,
  qt as getZXingModule,
  tn as purgeZXingModule,
  Gt as setZXingModuleOverrides,
  Kt as writeBarcodeToImageFile,
  nn as writeInputEccLevels
};
