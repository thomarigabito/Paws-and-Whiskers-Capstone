import { g as oi, s as si, r as ui, a as li } from "../core-7dHX86aP.js";
import { b as mi, c as $i, e as bi, f as wi, d as Ti, d as Pi, h as Ci, p as Ai, i as Fi, t as Ei } from "../core-7dHX86aP.js";
var Ae = (() => {
  ...
  return function(z = {}) {
    ...
    var Ge = Object.assign({}, l), Ze = "./this.program", qe = typeof window == "object", Je = typeof Bun < "u", ce = typeof importScripts == "function";
    ...
    var Fe;
    (qe || ce || Je) && (ce ? H = self.location.href : typeof document < "u" && document.currentScript && (H = document.currentScript.src), M && (H = M), H.indexOf("blob:") !== 0 ? H = H.substr(0, H.replace(/[?#].*/, "").lastIndexOf("/") + 1) : H = "", ce && (Fe = (e) => {
    ...
    var fe, Ke = !1, k, O, X, ee, D, m, Qe, er;
    function rr() {
      var e = fe.buffer;
      l.HEAP8 = k = new Int8Array(e), l.HEAP16 = X = new Int16Array(e), l.HEAPU8 = O = new Uint8Array(e), l.HEAPU16 = ee = new Uint16Array(e), l.HEAP32 = D = new Int32Array(e), l.HEAPU32 = m = new Uint32Array(e), l.HEAPF32 = Qe = new Float32Array(e), l.HEAPF64 = er = new Float64Array(e);
    }
    var tr = [], nr = [], ir = [];
    function Ur() {
      if (l.preRun)
    ...
    function ve(e) {
      var r;
      (r = l.onAbort) === null || r === void 0 || r.call(l, e), e = "Aborted(" + e + ")", K(e), Ke = !0, e += ". Build with -sASSERTIONS for more info.";
      var t = new WebAssembly.RuntimeError(e);
      throw le(t), t;
    }
    var Xr = "data:application/octet-stream;base64,", ar = (e) => e.startsWith(Xr), G;
    G = "zxing_reader.wasm", ar(G) || (G = Ir(G));
    function or(e) {
      if (e == G && Q)
    ...
    function Gr(e) {
      return !Q && (qe || ce || Je) && typeof fetch == "function" ? fetch(e, {
        credentials: "same-origin"
      }).then((r) => {
        if (!r.ok)
          throw "failed to load wasm binary file at '" + e + "'";
        return r.arrayBuffer();
      }).catch(() => or(e)) : Promise.resolve().then(() => or(e));
    }
    function sr(e, r, t) {
    ...
    function Zr(e, r, t, n) {
      return !e && typeof WebAssembly.instantiateStreaming == "function" && !ar(r) && typeof fetch == "function" ? fetch(r, {
        credentials: "same-origin"
      }).then((i) => {
        var a = WebAssembly.instantiateStreaming(i, t);
        return a.then(n, function(o) {
          return K(`wasm streaming compile failed: ${o}`), K("falling back to ArrayBuffer instantiation"), sr(r, t, n);
        });
      }) : sr(r, t, n);
    }
    function qr() {
      ...
      function r(n, i) {
        return F = n.exports, fe = F.ia, rr(), gr = F.ma, Br(F.ja), zr(), F;
      }
      Lr();
      function t(n) {
        r(n.instance);
    ...
    var de = [], he = 0, Jr = (e) => {
      var r = new Se(e);
      return r.get_caught() || (r.set_caught(!0), he--), r.set_rethrown(!1), de.push(r), Dr(r.excPtr), r.get_exception_ptr();
    }, x = 0, Kr = () => {
      $(0, 0);
      var e = de.pop();
      Rr(e.excPtr), x = 0;
    ...
    var Qr = (e) => {
      ...
      return ue(n), r;
    }, et = () => Re([]), rt = (e) => Re([e]), tt = (e, r) => Re([e, r]), nt = () => {
      var e = de.pop();
    ...
    function lt(e, r) {
      ...
      if (N[e] = r, delete _e[e], Z.hasOwnProperty(e)) {
        var i = Z[e];
    ...
    var U = 8, ct = (e, r, t, n) => {
      ...
      if (t.baseClass === void 0)
        return null;
      var n = vr(e, r, t.baseClass);
      return n === null ? null : t.downcast(n);
    }, dr = {}, dt = () => Object.keys(ie).length, ht = () => {
      var e = [];
      for (var r in ie)
      ...
      l.getInheritedInstanceCount = dt, l.getLiveInheritedInstances = ht, l.flushPendingDeletes = je, l.setDelayFunction = pt;
    }, ie = {}, gt = (e, r) => {
      for (r === void 0 && g("ptr should not be undefined"); e.baseClass; )
        r = e.upcast(r), e = e.baseClass;
      return r;
    }, yt = (e, r) => (r = gt(e, r), ie[r]), ye = (e, r) => {
    ...
    function mt(e) {
      ...
      var a = this.registeredClass.getActualType(r), o = dr[a];
      if (!o)
        return i.call(this);
      var s;
      this.isConst ? s = o.constPointerType : s = o.pointerType;
      var u = vr(r, this.registeredClass, s.registeredClass);
    ...
    var ae = (e) => typeof FinalizationRegistry > "u" ? (ae = (r) => r, e) : (ke = new FinalizationRegistry((r) => {
      ...
      Object.assign(me.prototype, {
        ...
        delete() {
          this.$$.ptr || We(this), this.$$.deleteScheduled && !this.$$.preservePointerOnDelete && g("Object already scheduled for deletion"), cr(this), fr(this.$$), this.$$.preservePointerOnDelete || (this.$$.smartPtr = void 0, this.$$.ptr = void 0);
        },
        isDeleted() {
          return !this.$$.ptr;
        },
    ...
    var oe = (e, r) => Object.defineProperty(r, "name", {
      ...
      l.hasOwnProperty(e) ? ((t === void 0 || l[e].overloadTable !== void 0 && l[e].overloadTable[t] !== void 0) && g(`Cannot register public name '${e}' twice`), hr(l, e, e), l.hasOwnProperty(t) && g(`Cannot register multiple overloads of a function with the same number of arguments (${t})!`), l[e].overloadTable[t] = r) : (l[e] = r, t !== void 0 && (l[e].numArguments = t));
    }, bt = 48, wt = 57, Tt = (e) => {
      if (e === void 0)
        return "_unknown";
    ...
    function $e(e, r, t, n, i, a, o, s, u, f, v) {
      this.name = e, this.registeredClass = r, this.isReference = t, this.isConst = n, this.isSmartPointer = i, this.pointeeType = a, this.sharingPolicy = o, this.rawGetPointee = s, this.rawConstructor = u, this.rawShare = f, this.rawDestructor = v, !i && r.baseClass === void 0 ? n ? (this.toWireType = Ct, this.destructorFunction = null) : (this.toWireType = Ft, this.destructorFunction = null) : this.toWireType = At;
    }
    var _r = (e, r, t) => {
      ...
      var r = be[e];
      return r || (e >= be.length && (be.length = e + 1), be[e] = r = gr.get(e)), r;
    }, Rt = (e, r, t) => {
      if (e.includes("j"))
        return St(e, r, t);
      ...
      e = S(e);
      function t() {
        return e.includes("j") ? Dt(e, r) : w(r);
      }
      var n = t();
...
` + i.replace(/^Error(:[^\n]*)?\n/, ""));
      ...
      Me(_, function() {
        ...
        var R = oe(v, function() {
          ...
          var Hr = d.constructor_body[arguments.length];
          if (Hr === void 0)
    ...
    function Ue(e, r, t, n, i, a) {
      ...
      var s = r[1] !== null && t !== null, u = kt(r), f = r[0].name !== "void", v = o - 2, h = new Array(v), p = [], _ = [], b = function() {
    ...
    var jt = (e, r, t, n, i, a) => {
      ...
      i = j(n, i), L([], [e], function(s) {
        ...
        }, L([], o, (f) => (f.splice(1, 0, null), s.registeredClass.constructor_body[r - 1] = Ue(u, f, null, i, a), [])), [];
      });
    }, $r = (e) => {
      e = e.trim();
      const r = e.indexOf("(");
      return r !== -1 ? e.substr(0, r) : e;
    }, Mt = (e, r, t, n, i, a, o, s, u) => {
      var f = Ie(t, n);
      r = S(r), r = $r(r), a = j(i, a), L([], [e], function(v) {
        v = v[0];
        var h = `${v.name}.${r}`;
        ...
        return b === void 0 || b.overloadTable === void 0 && b.className !== v.name && b.argCount === t - 2 ? (p.argCount = t - 2, p.className = v.name, _[r] = p) : (hr(_, r, h), _[r].overloadTable[t - 2] = p), L([], f, function(C) {
          var y = Ue(h, C, v, a, o);
    ...
    var W = new br(), xe = (e) => {
      ...
      W.allocated.push({
        ...
        value: !1
      }), W.reserved = W.allocated.length, l.count_emval_handles = It;
    }, V = {
      ...
      i.values = {}, I(e, {
        ...
        argPackAdvance: U,
        readValueFromPointer: Vt(r, t, n),
        destructorFunction: null
      }), Me(r, i);
    }, Ve = (e, r) => {
      var t = N[e];
      return t === void 0 && g(r + " has unknown type " + mr(e)), t;
    }, Bt = (e, r, t) => {
      var n = Ve(e, "enum");
      r = S(r);
      ...
      switch (r) {
        case 4:
          return function(t) {
            return this.fromWireType(Qe[t >> 2]);
          };
        case 8:
          return function(t) {
      ...
      r = S(r), I(e, {
        ...
        toWireType: (n, i) => i,
        argPackAdvance: U,
        readValueFromPointer: Nt(r, t),
        destructorFunction: null
      });
    }, zt = (e, r, t, n, i, a, o) => {
      var s = Ie(r, t);
      e = S(e), e = $r(e), i = j(n, i), Me(e, function() {
        we(`Cannot call ${e} due to unbound types`, s);
      }, r - 1), L([], s, function(u) {
        var f = [u[0], null].concat(u.slice(1));
        return _r(e, Ue(e, f, null, i, a), r - 1), [];
      });
    }, Xt = (e, r, t) => {
      switch (r) {
        case 1:
      ...
      s ? f = function(v, h) {
        ...
        toWireType: f,
        argPackAdvance: U,
        readValueFromPointer: Xt(r, t, n !== 0),
        destructorFunction: null
      });
    }, Zt = (e, r, t) => {
      ...
      return r[t] = 0, t - i;
    }, qt = (e, r, t) => wr(e, O, r, t), Tr = (e) => {
      for (var r = 0, t = 0; t < e.length; ++t) {
        var n = e.charCodeAt(t);
        n <= 127 ? r++ : n <= 2047 ? r += 2 : n >= 55296 && n <= 57343 ? (r += 4, ++t) : r += 3;
      }
      return r;
    }, Pr = typeof TextDecoder < "u" ? new TextDecoder("utf8") : void 0, Jt = (e, r, t) => {
      ...
      I(e, {
        ...
        toWireType(n, i) {
          ...
          o || i instanceof Uint8Array || i instanceof Uint8ClampedArray || i instanceof Int8Array || g("Cannot pass non-string to std::string"), t && o ? a = Tr(i) : a = i.length;
    ...
    }, Cr = typeof TextDecoder < "u" ? new TextDecoder("utf-16le") : void 0, Qt = (e, r) => {
      for (var t = e, n = t >> 1, i = n + r / 2; !(n >= i) && ee[n]; )
        ++n;
      if (t = n << 1, t - e > 32 && Cr)
        return Cr.decode(O.subarray(e, t));
      ...
      t = S(t);
      var n, i, a, o, s;
      r === 2 ? (n = Qt, i = en, o = rn, a = () => ee, s = 1) : r === 4 && (n = tn, i = nn, o = an, a = () => m, s = 2), I(e, {
        name: t,
        fromWireType: (u) => {
    ...
    }, Ne = [], cn = (e, r, t, n) => (e = Ne[e], r = V.toValue(r), e(null, r, t, n)), fn = {}, vn = (e) => {
      var r = fn[e];
    ...
    }, dn = (e) => e === 0 ? V.toHandle(Ar()) : (e = vn(e), V.toHandle(Ar()[e])), hn = (e) => {
      var r = Ne.length;
      return Ne.push(e), r;
    }, pn = (e, r) => {
      ...
      ve("");
    }, Tn = (e, r, t) => O.copyWithin(e, r, r + t), Pn = () => 2147483648, Cn = (e) => {
      var r = fe.buffer, t = (e - r.byteLength + 65535) / 65536;
      try {
        return fe.grow(t), rr(), 1;
      } catch {
      }
    }, An = (e) => {
      var r = O.length;
      ...
      return se().forEach((n, i) => {
        var a = r + t;
        m[e + i * 4 >> 2] = a, En(n, a), t += n.length + 1;
      }), 0;
    }, Rn = (e, r) => {
      var t = se();
      m[e >> 2] = t.length;
    ...
    }, Dn = (e) => e, Te = (e) => e % 4 === 0 && (e % 100 !== 0 || e % 400 === 0), On = (e, r) => {
      for (var t = 0, n = 0; n <= r; t += e[n++])
        ;
      return t;
    }, Fr = [31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31], Er = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31], Wn = (e, r) => {
      for (var t = new Date(e.getTime()); r > 0; ) {
        var n = Te(t.getFullYear()), i = t.getMonth(), a = (n ? Fr : Er)[i];
        if (r > a - t.getDate())
    ...
    function kn(e, r, t) {
      var n = t > 0 ? t : Tr(e) + 1, i = new Array(n), a = wr(e, i, 0, i.length);
    ...
    var jn = (e, r) => {
      ...
      function C(c) {
        var d = Wn(new Date(c.tm_year + 1900, 0, 1), c.tm_yday), A = new Date(d.getFullYear(), 0, 4), E = new Date(d.getFullYear() + 1, 0, 4), J = b(A), Ce = b(E);
      ...
      var y = {
        ...
        "%j": (c) => p(c.tm_mday + On(Te(c.tm_year + 1900) ? Fr : Er, c.tm_mon - 1), 3),
        "%m": (c) => p(c.tm_mon + 1, 2),
        "%M": (c) => p(c.tm_min, 2),
        "%n": () => `
`,
      ...
      o = o.replace(/\0\0/g, "%");
      var R = kn(o, !1);
      return R.length > r ? 0 : (jn(R, e), R.length - 1);
    }, Hn = (e, r, t, n, i) => Mn(e, r, t, n);
    ur = l.InternalError = class extends Error {
      constructor(r) {
        super(r), this.name = "InternalError";
      }
    }, ut(), q = l.BindingError = class extends Error {
      constructor(r) {
        super(r), this.name = "BindingError";
      }
    }, $t(), _t(), Et(), yr = l.UnboundTypeError = Ot(Error, "UnboundTypeError"), Ht(), Ut();
    var In = {
      s: Jr,
      u: Kr,
      b: et,
      ...
      fa: Dn,
      T: Hn
    }, F = qr(), Y = l._free = (e) => (Y = l._free = F.ka)(e), ze = l._malloc = (e) => (ze = l._malloc = F.la)(e), Sr = (e) => (Sr = F.na)(e), $ = (e, r) => ($ = F.oa)(e, r), ue = (e) => (ue = F.pa)(e), T = () => (T = F.qa)(), P = (e) => (P = F.ra)(e), Rr = (e) => (Rr = F.sa)(e), Dr = (e) => (Dr = F.ta)(e), Or = (e, r, t) => (Or = F.ua)(e, r, t), Wr = (e) => (Wr = F.va)(e);
    l.dynCall_viijii = (e, r, t, n, i, a, o) => (l.dynCall_viijii = F.wa)(e, r, t, n, i, a, o);
    var kr = l.dynCall_jiiii = (e, r, t, n, i) => (kr = l.dynCall_jiiii = F.xa)(e, r, t, n, i);
    ...
    function Gn(e, r, t, n, i, a, o, s, u, f, v) {
      var h = T();
      try {
    ...
    function ii(e, r, t, n, i, a, o, s, u, f, v, h, p, _, b, C) {
      var y = T();
      try {
    ...
    function jr() {
      if (B > 0 || (Ur(), B > 0))
        return;
      function e() {
        Pe || (Pe = !0, l.calledRun = !0, !Ke && (xr(), Xe(l), l.onRuntimeInitialized && l.onRuntimeInitialized(), Vr()));
      }
...
export {
  mi as barcodeFormats,
  $i as binarizers,
  bi as characterSets,
  wi as contentTypes,
  Ti as defaultDecodeHints,
  Pi as defaultReaderOptions,
  Ci as eanAddOnSymbols,
  di as getZXingModule,
  Ai as purgeZXingModule,
  _i as readBarcodesFromImageData,
  pi as readBarcodesFromImageFile,
  Fi as readOutputEccLevels,
